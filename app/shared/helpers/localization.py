...
INTERNAL_MESSAGES: Dict[str, str] = {
    ...
    "screening_doc_check_started": "Screening dimulai: verifikasi dokumen",
    "screening_knockout_failed_reason": "Gagal kualifikasi (Knockout): {rule_name}",
    "screening_ai_processing_started": "Dokumen valid, lanjut proses AI",
...
ERROR_MESSAGES: Dict[str, str] = {
    ...
    ERR_USER_EMAIL_ALREADY_EXISTS: "Email pengguna sudah terdaftar",
    ...
    ERR_SUPER_ADMIN_ALREADY_EXISTS: "Administrator utama sudah terdaftar. Gunakan endpoint login.",
